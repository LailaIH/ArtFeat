                  ...
                  <div class="row m-5">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">Creato Picture</div>
                                    <div class="card-body text-center">
                                        <!-- Profile picture image-->
                                        <img id="support-image" width="160" height="160" class="img-account-profile rounded-circle mb-1" src="{{ isset($creator->img)? asset('creatorsImages/'.$creator->img) : asset('assets/img/noitem.png') }}" alt="support pic" />
                                        <!-- Profile picture help block-->
                                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                        <!-- Profile picture upload button-->
                                        <form  method="POST" action="{{ route('creators.update',$creator->id) }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                        @method('PUT')
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Creator Details</div>
                                    <div class="card-body">
                                        ...
                                        <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="name" type="text" name="name"  required value="{{$creator->name}}" />
                                                    @error('name')
                                                        {{$message}}
                                                        @enderror
                                                ...
                                                <div class="col-md-6 " style="margin-top: 2.3rem;">
                                                        ...
                                                        <input class="form-check-input ml-3" type="checkbox" name="is_online"  @if ($creator->is_online) checked @endif>
