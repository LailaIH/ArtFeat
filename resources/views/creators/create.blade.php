                  ...
                  <div class="row m-5">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">Creator Picture</div>
                                    <div class="card-body text-center">
                                        ...
                                        <form  method="POST" action="{{ route('creators.store') }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Creators Details</div>
                                    <div class="card-body">
