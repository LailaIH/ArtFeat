        ...
        <div class="container mt-n5">
                    ...
                    <form action="{{ route('collections.update',$collection) }}" method="POST" >
                        ...
                        <div class="col-md-6">
                            ...
                            <input value="{{$collection->artist->name}}" class="form-control" readonly/>
                        </div>

                        <div class="col-md-6">
                        <label class="small mb-1" for="name">Name</label>
                        <input value="{{$collection->name}}" type="text" name="name" id="name" class="form-control" required/>
                        @error('name')
                                {{$message}}
                        @enderror
                        </div>
                        ...
                        <textarea value="{{$collection->description}}" type="text" name="description" id="description" class="form-control">
                        ...
                        <div class="col-md-6 mt-5 ">
                            ...
                            <input class="form-check-input ml-3" type="checkbox" name="is_online"  @if ($collection->is_online) checked @endif>
