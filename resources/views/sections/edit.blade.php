                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img id="product-image" width="160" height="160" class="img-account-profile rounded-circle mb-1" src="{{ asset('sectionImages/'.$section->img) }}" alt="section pic" />
                                        <!-- Profile picture help block-->
                                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                        <!-- Profile picture upload button-->
                                        <form  method="POST" action="{{ route('sections.update', ['id'=>$section['id']]) }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="name" type="text" name="name" value="{{ $section->name }}" required />
                                                    @error('name')
                                                        {{$message}}
                                                        @enderror
