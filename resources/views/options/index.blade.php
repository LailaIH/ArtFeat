                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-12 col-md-6 mt-4 text-right">
                            <a href="/admin/options" class="btn btn-outline-white rounded-pill btn-sm" role="button">Panel Options <i class="fas fa-cog ml-1"></i></a>
        ...
        <div class="container mt-n5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="container">
                        <h1 class="text-primary">Panel Settings Pageيييي</h1>
