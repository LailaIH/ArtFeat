                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                         @csrf
                                            ...
                                            <div class="mb-3">
                                                <label class="text-gray-600 small" for="emailExample">{{ __('Email Address') }}</label>

                                                <input id="email" type="email" class="form-control form-control-solid @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>                                            </div>
                                            <!-- Form Group (password)-->
                                            @error('email')
