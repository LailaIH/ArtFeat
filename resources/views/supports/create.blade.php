                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img id="support-image" width="160" height="160" class="img-account-profile rounded-circle mb-1" src="/assets/img/noitem.png" alt="support pic" />
                                        <!-- Profile picture help block-->
                                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                        <!-- Profile picture upload button-->
                                        <form  method="POST" action="{{ route('supports.store') }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                        ...
                                        <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="title" type="text" name="title"  required value="{{old('title')}}" />
                                                    @error('title')
                                                        {{$message}}
                                                        @enderror
