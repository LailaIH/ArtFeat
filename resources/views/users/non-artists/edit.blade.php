        ...
        <div class="row m-5">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">{{$nonArtist->name}}'s picture</div>
                                    <div class="card-body text-center">
                                        <!-- Profile picture image-->
                                        @if($nonArtist->img)
                                        <img id="profile-image" width="160" height="160" class="img-account-profile rounded-circle mb-1" src="{{ asset('userImages/'.$nonArtist->img) }}" alt=" user pic " />
                                        @else
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">{{$nonArtist->name}}'s details</div>
                                    <div class="card-body">
                                        ...
                                        <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="name" type="text" name="name" value="{{ $nonArtist->name }}" required />
                                                </div>
                                            ...
                                            <select name="job_title_id" id="job_title_id" class="form-control form-control-solid" required>
                                                ...
                                                @foreach ($jobTitles as $job)
                                                    <option value="{{ $job->id }}" @if ($nonArtist->job_title_id == $job->id) selected @endif>{{ $job->name }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="col-12">
                                                   ...
                                                   <input class="form-control" id="price" type="number" name="points" value="{{ $nonArtist->points }}"  />
                                               </div> </div>
                                            ...
                                            <input class="form-check-input ml-3" type="checkbox" name="is_artist"  @if ($nonArtist->is_artist) checked @endif>
