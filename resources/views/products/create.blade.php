                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img id="product-image" width="160" height="160" class="img-account-profile rounded-circle mb-1" src="/assets/img/noproduct.png" alt="product pic" />
                                        <!-- Profile picture help block-->
                                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                        <!-- Profile picture upload button-->
                                        <form  method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                            ...
                                            {{$message}}
                                              @enderror
                                               ...
                                               <div class="col-md-6">
                                                   ...
                                                   <input class="form-control" id="stock_quantity" type="number" name="stock_quantity" value="{{old('stock_quantity')}}"  required />
