                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <form  method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                               ...
                                               <input class="form-control" id="starts_at" type="date" name="starts_at"   value="{{old('starts_at')}}" />
                                                    @error('starts_at')
                                                        {{$message}}
                                                        @enderror
                                               </div>
