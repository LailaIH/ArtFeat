                                ...
                                <table id="myTable" class="table small-table-text">
                                    ...
                                    @foreach ($events as $event)
                                        <tr style="white-space: nowrap; font-size: 14px;">
                                            ...
                                            <td class=" text-black"><b>{{ $event->title }}</b></td>
                                            <td>    
                                            ...
                                            <td>
                                                    @if(isset($event->img))
                                                    <img src="{{ asset('eventsImages/'.$event->img) }}" alt="event picture" width="100" height="100">
                                                    @else
                                                    <img src="{{ asset('assets/img/noitem.png') }}" alt="event picture" width="100" height="100">
                                                    @endif 
                                            </td>
                                           
                                            <td>

                                                    <span class="badge {{ $event->is_online ? 'badge-green' : 'badge-red' }}">
                                            ...
                                            <td>
                                                <a href="{{ route('events.edit',  ['id'=>$event['id']]) }}" class="btn btn-primary btn-xs">Edit</a>
